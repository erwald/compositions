...
euclidToMusic dur p (_, ds) = line $ map toNote ds
    where toNote d = note ((toRational d) * dur) p
...
euclidToMusicVaried dur p vars (o, ds)
    | o > 0 = initialRest :+: euclidToMusicVaried dur p vars (0, ds)
    where initialRest = Prim (Rest ((toRational o) * dur))
...
generateRhythms2 totalDur o1 k1 o2 k2 = monoizeDistancesL
    [ (o1, superEuclid k1 totalDur)
    , (o2, superEuclid k2 totalDur)
    ]

generateRhythms3 :: Int -> Int -> [Int] -> Int -> [Int] -> Int -> [Int] -> [EuclideanRhythm]
generateRhythms3 totalDur o1 k1 o2 k2 o3 k3 = monoizeDistancesL
    [ (o1, superEuclid k1 totalDur)
    , (o2, superEuclid k2 totalDur)
    , (o3, superEuclid k3 totalDur)
    ]
...
dance1 section = line $ map (uncurry3 genCycle) $ drop section
                -- Introduction
            [   ( [(Af, 2), (C, 4)]
                , [ [(-2, appog 2)]
                  , [ (5, mord 1), (-8, sub (Bf, 3)), (-5, sub (Bf, 3)), (-3, mord 1)]
                  ]
            ...
            ,   ( [(Af, 1), (C, 3), (F, 4)] -- IV (climax)
                , [ [(0, mord 2), (4, mord 2), (7, mord 2), (-2, sub (Bf, 1))]
                  , [(3, mord 1), (-3, mord 1)]
                  , [(1, sub (G, 4)), (4, sub (G, 4)), (5, sub (Af, 4)), (6, sub (Af, 4)), (7, sub (Af, 4)), (9, sub (G, 4)), (-5, sub (Ef, 4))]
                  ]
